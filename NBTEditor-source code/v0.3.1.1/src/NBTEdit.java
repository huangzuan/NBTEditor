    ...
    static class TagWrapper {
        ...
        public String toString() {
            ...
            if (tag instanceof StringTag s) {
                return name + ": \"" + s.getValue() + "\"";
            }

            if (tag instanceof IntArrayTag intArrayTag) {
                return name + ": " + Arrays.toString(intArrayTag.getValue());
            }

            if (tag instanceof ByteArrayTag byteArrayTag) {
                return name + ": " + Arrays.toString(byteArrayTag.getValue());
            }

            if (tag instanceof LongArrayTag longArrayTag) {
                return name + ": " + Arrays.toString(longArrayTag.getValue());
            }
